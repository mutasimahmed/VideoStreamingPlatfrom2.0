...
<div className="bg-black mb-2 text-white p-1 sm:p-2 rounded-lg flex justify-between ">
  ...
  <div className="flex justify-around w-72">
   ...
   setQrcodeShow(!qrcodeShow)
    ...
    } className={`p-3 font-bold cursor-pointer`}><FontAwesomeIcon icon={faQrcode} className={classValue}/> {qrcodeShow==true?<span className={classValue}>Hide</span>:<span className={classValue}>share </span>}</h3>
</div>
</div>
    </div>
